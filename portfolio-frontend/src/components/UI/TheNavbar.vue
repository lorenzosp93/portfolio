      ...
      <nav class="">
            ...
            <div class="flex-1 flex items-center justify-end sm:items-stretch sm:justify-start">
              ...
              <div class="hidden  sm:block my-auto sm:ml-6">
                <div class="flex space-x-4">
                  ...
                  <a href="#" class="text-black dark:text-gray-300 px-3 py-2 rounded-md text-sm font-medium" :class="{active: elementInView === 'the-blog'}">Blog</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="sm:hidden bg-white dark:bg-gray-700 rounded-lg mx-3 ring-1 ring-gray-100 dark:ring-gray-600 relative" :class="{'hidden': !isMenuOpen,}" id="mobile-menu">
          <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="#the-resume" class="block text-black dark:text-gray-300px-3 px-3 py-2 rounded-md text-sm font-medium" :class="{active: ['experience', 'education'].includes(elementInView)}">Resume</a>
            <a href="#experience" class="block text-black dark:text-gray-300px-3 px-3 py-2 rounded-md text-sm font-medium scroll-smooth" v-show="['experience', 'education'].includes(elementInView)" :class="{active_outer: ['experience'].includes(elementInView)}">Experience</a>
            ...
            <a href="#" class="block text-black dark:text-gray-300 px-3 py-2 rounded-md text-sm font-medium" :class="{active: elementInView === 'the-blog'}">Blog</a>
          </div>
        </div>
      </nav>
    </slot>
