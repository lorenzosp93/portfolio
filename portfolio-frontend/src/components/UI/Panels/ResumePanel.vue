<template>
  <div
    class="m-auto rounded-lg md:max-w-xl lg:max-w-4xl xl:max-w-6xl overflow-y-scroll overflow-x-hidden shadow-md bg-white dark:bg-gray-900 py-1 mx-auto no-scrollbar border-2 dark:border-gray-900 border-white max-w-[99%]"
