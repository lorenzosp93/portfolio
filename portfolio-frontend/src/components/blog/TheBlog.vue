<template>
  <div class="container min-h-[50vh] :min-h-[70vh] relative flex w-screen mx-auto flex-wrap">
    ...
    <div class="p-auto container relative w-screen flex overflow-x-scroll no-scrollbar snap-x snap-mandatory m-auto scroll-smooth" id="blog-container">
      ...
      <div class="w-3/5 md:w-1/3 lg:w-1/4 p-10 m-auto" v-if="isLoading">
      ...
      <div @click="loadEntries" v-else-if="!data.length" class="rounded-3xl h-fit p-3 mx-auto mt-5 mb-20 bg-gray-300 text-white dark:bg-gray-500">
