<template>
  <div class="container min-h-[55vh] lg:min-h-[60vh] relative flex w-screen mx-auto flex-wrap">
    ...
    <div class="p-auto gap-6 container relative w-screen flex overflow-x-scroll no-scrollbar snap-x snap-mandatory m-auto scroll-smooth scroll-px-1 p-5" id="blog-container">
