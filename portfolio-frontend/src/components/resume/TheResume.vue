...
<div class="container relative min-h-screen w-screen mx-auto mt-10">
  <div class="class container flex flex-wrap mx-auto mb-10">
    ...
    <p class="text-center w-full text-gray-600 dark:text-gray-300">
      Because I definitely needed a website to host my CV. <span class="md:hidden"> Swipe horizontally to change
        section!</span>
    </p>
  </div>
  <div class="z-10 sticky top-1/2 hidden md:block max-w-screen-lg mx-auto" id="arrow-holder-resume">
    <div @click="scrollToSibling(false)"
      ...
      <div
        class="translate-y-full translate-x-1/4 h-1/3 w-1/3 mx-auto rotate-45 border-b-2 border-l-2 border-gray-600 dark:border-gray-900 box-border rounded-bl">
      </div>
    </div>
    <div @click="scrollToSibling(true)"
      ...
      <div
        class="translate-y-full -translate-x-1/4 h-1/3 w-1/3 mx-auto rotate-45 border-t-2 border-r-2 border-gray-600 dark:border-gray-900 box-border rounded-tr">
      </div>
    </div>
  </div>
