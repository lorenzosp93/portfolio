<template>
  <div class="m-auto rounded-lg max-w-screen-lg shadow-md bg-white dark:bg-gray-900">
    <div class="relative p-auto w-full ">
      ...
      <ol v-else-if="entries.length > 0" class="relative border-l-2 border-gray-200 dark:border-gray-600 ml-5">
        <timeline-group
...
export default {
  ...
  methods: {
    loadEntries (kind) {
      let url = '/api/resume/entity-entries/' + kind + '/';
