  ...
  <section class="flex min-h-screen w-screen flex-wrap text-black dark:text-white">
    ...
    <div class="relative flex-initial w-1/2 sm:w-1/3 m-auto py-5" >
      ...
      <div class="container flex mt-5">
        ...
        <a class=" fill-gray-700 dark:fill-white ml-auto" href="https://twitter.com/Lorenzosp" aria-label="Twitter profile">
        ...
        <a href="https://www.linkedin.com/in/lorenzosp/" class="fill-gray-700 dark:fill-white mx-5" aria-label="Linkedin profile">
        ...
        <a href="https://github.com/lorenzosp93" class="fill-gray-700 dark:fill-white mr-auto" aria-label="Github space">
